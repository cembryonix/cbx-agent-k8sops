# models/model-reference-list.py

# NOTE: this file is only to keep a reference list of LLM models
#
# It is not used in the normal App flow

REFERENCE_SUPPORTED_MODELS = {
    "global_config": {
        "temperature": 0.1,
        "max_tokens": 2000,
        "timeout": 30,
